...
- (id)init{
    if (self = [super init]){
        ...
        CCSprite *mountainSprite = [CCSprite spriteWithFile:@"Foreground_iPhone5.png"];
        ...
        new_Cloud = [[[MSCloud alloc] initFrontCloud:(winSize.width/2)] autorelease];
        [m_FrontCloudArray addObject:new_Cloud];
        [self addChild:new_Cloud z:1];
        ...
        new_Cloud = [[[MSCloud alloc] initBackCloud:(3*winSize.width/2)] autorelease];
        [m_FrontCloudArray addObject:new_Cloud];
        [self addChild:new_Cloud z:0];
        
        new_Cloud = [[[MSCloud alloc] initBackCloud:(winSize.width/2)] autorelease];
        [m_FrontCloudArray addObject:new_Cloud];
        [self addChild:new_Cloud z:0];
...
{
    MSCloud *new_Cloud = [[[MSCloud alloc] initFrontCloud:(-m_FrontCloudWidth/2)] autorelease];
    [m_FrontCloudArray addObject:new_Cloud];
    [self addChild:new_Cloud z:1];
}
...
-(void) spawnBackCloud
{
    MSCloud *new_Cloud = [[[MSCloud alloc] initBackCloud:(-m_BackCloudWidth/2)] autorelease];
